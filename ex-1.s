...
.text
#current section text new org 0 0x000
.org 0x000
    j  main
.org 0x0020
.ifndef x
...
main: 
    ...
    xori x7, 0x30       # XOR immediate (7-bit max)
...
final_section:
    ...
    # Final exit
.equ exit_code, 0x00A  # Exit code for system call
.data 
.string "Hello, ZX16!"  # String data for testing
